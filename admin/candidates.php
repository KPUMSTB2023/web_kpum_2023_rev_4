                    ...
                    <div class="col-lg-4">
                        <div class="card p-3 mb-4">
                            <form method="post">
                                ...
                                <input type="text" name="nama_capresma" value="<?= htmlspecialchars($kandidat['nama_capresma'], ENT_QUOTES, 'UTF-8') ?>">
                                <input type="hidden" name="id" value="<?= htmlspecialchars($kandidat['id'], ENT_QUOTES, 'UTF-8') ?>">
                                <label>Nama Cawapresma :</label>
                                <input type="text" name="nama_cawapresma" value="<?= htmlspecialchars($kandidat['nama_cawapresma'], ENT_QUOTES, 'UTF-8') ?>">
